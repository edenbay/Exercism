...
namespace estate_executor {
    ...
    int assemble_account_number(int secret_modifier) {
        ...
        int zhang_number = zhang::bank_number_part(secret_modifier);
        int khan_number = khan::bank_number_part(secret_modifier);
        int garcia_number = garcia::bank_number_part(secret_modifier);


        return zhang_number + khan_number + garcia_number;
    }
